...
const FROM = process.env.EMAIL_FROM ?? 'DirigeComigo <noreply@dirigecomigo.com.br>'
const APP_NAME = 'DirigeComigo'
            ...
            <td style="padding:36px 40px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-top:28px;">
                <tr>
                  <td>
                    <a
                      href="${process.env.NEXT_PUBLIC_APP_URL ?? 'https://dirigecomigo.com.br'}/onboarding?role=instructor"
